<div align="center">
    ...
    <h1>Discord Roles - Team Zenpie</h1>
</div>
...
| Name           | Description                                                                                                           |
|----------------|-----------------------------------------------------------------------------------------------------------------------|
| The Zenpie          | ZenpieDragon.  Discord: `ZenpieDragon` UID: `1256609678071304202`                                              |
| Leader     | Looks after all the core activities related to Zenpie and his team.                                                   |
| Acting Leader    | Manages the server with rules and regulations. They have the right to take the necessary action against the offender. |
| Management Team |  Handles staff supervision, planning, and server organization.                                         |
| Staff Team | Staff Team is responsible for maintaining a safe, friendly, and organized environment within the server.                                          |
